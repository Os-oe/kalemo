...
export const T = {
  de: {
    ...
    missTitle: 'Ich hab’s nicht erkannt — so malen es andere:', helpOthers: 'Zeig mir, wie andere es malen', helpBubble: 'Schauen wir mal, wie andere es malen.', languages: 'Sprachen', round: 'Runde',
  ...
  en: {
    ...
    missTitle: 'I couldn’t tell — this is how others draw it:', helpOthers: 'Show me how others draw it', helpBubble: 'Let’s see how others draw it.', languages: 'Languages', round: 'Round',
  ...
  tr: {
    ...
    missTitle: 'Anlayamadım — başkaları böyle çiziyor:', helpOthers: 'Başkaları nasıl çiziyor, göster', helpBubble: 'Bakalım başkaları nasıl çizmiş.', languages: 'Diller', round: 'Tur',
